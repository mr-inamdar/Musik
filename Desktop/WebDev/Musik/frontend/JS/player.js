...
document.addEventListener('DOMContentLoaded', () => {
    try {
        ...
        //for avoiding refresh bug
        localStorage.setItem('playList', (localStorage.getItem('PlaylistSongList') || []))
        songs = JSON.parse(localStorage.getItem('playList')) || [];
        localStorage.setItem('song', (localStorage.getItem('currentSong') || []))
        const storedCurrentSong = localStorage.getItem('song') || [];
